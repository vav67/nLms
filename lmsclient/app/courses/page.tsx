...
//https://github.com/vercel/next.js/discussions/61654  aseph8083  on Feb 6   Автор
//Раньше пользовался 13 версией, после обновления до версии 14.1 появилась ошибка
...
//   // пока   const searchParams = useSearchParams()
//       //берем значение 
//   //пока  const search = searchParams?.get("title");
